...
5. **Telegram Bot (@HURMO_UZ_NOTIFICATIONS_BOT)**:
   - Токен: `8947372834:AAFaBgNc0qNX12PSSPJ-hAuFYwfgLYi6J78`
   - Команды:
...
|---|---|---|---|
| `admin` | `hurmo_secure_pass_2026` | `super_admin` | Главный администратор |
| `manager_dilshod` | `manager_secret_2026` | `manager` | Аналитик / Менеджер |
| `operator_aziz` | `operator_secret_2026` | `operator` | Оператор колл-центра |
